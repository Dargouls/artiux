				...
				{!isMobile && (
					<EffectComposer>
						<DepthOfField
							...
							focalLength={0.3} // comprimento focal (menor = mais blur)
							bokehScale={0.05} // intensidade do bokeh/blur
							height={120} // resolução do efeito, bem abaixo da resolução da tela
						/>
					</EffectComposer>
				)}
			</Canvas>
